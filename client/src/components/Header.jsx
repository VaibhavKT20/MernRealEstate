  ...
  return (
    <header className="bg-gradient-to-r from-gray-800 to-black text-white py-6">
      <div className="container mx-auto flex flex-col md:flex-row justify-center items-center">
        <Link
          to="/"
          className="text-4xl font-extrabold text-center mb-4 md:mb-0 md:mr-6"
        >
          Home<span className="text-blue-500">Haven</span>
        </Link>
        <form
          onSubmit={handleSubmit}
          className="flex items-center mx-auto mb-4 md:mb-0"
        >
          <input
            type="text"
            placeholder="Search..."
        ...
        <nav className="hidden md:flex gap-8">
          ...
          <Link
            to="/profile"
            className="flex items-center text-white hover:text-blue-500 transition duration-300"
          >
            {currentUser ? (
              <img
